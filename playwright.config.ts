...
export default defineConfig({
  ...
  workers: process.env.CI ? 1 : undefined, //Number of processes we run in parallel
  ...
  */
  ...
  use: {
    ...
    -- In case your app use always the same URL */
    // baseURL: 'http://127.0.0.1:3000',

    /* Collect trace when retrying the failed test. See https://playwright.dev/docs/trace-viewer 
    -- Help us understand the failed tests */
 ...
 // timeout: 30000, //https://playwright.dev/docs/test-timeouts
  ...
  // Group of settings thst the tests will run through
  projects: [
    {
      name: 'chromium',
...

    {
      ...
      // Example only
      // It's a better use to have setted up environments
      {
        name: 'local',
        use: { 
